// dict2.cairo
// Dictionaries can be used to simulate dynamic array : the value they store can be accessed and
// modified.
// Your task is to create a function that multiplies the elements stored at the indexes 0 to n of a
// dictionary by 10 Make me compile and pass the test!
...
fn multiply_element_by_10(ref dict: Felt252Dict<u32>, n: usize) {
    //TODO : make a function that multiplies the elements stored at the indexes 0 to n of a
    //dictionary by 10
    for i in 0..n {
        let (entry, value) = dict.entry(i.into());
        dict = entry.finalize(value * 10);
    }
}
